...
cat("Summary of DataSaison :", fill = TRUE)
cat(summary(DataSaison$nb_contacts), fill = TRUE)
...
cat("Distribution of response variable: ", fill = TRUE)
cat(summary(DataSaison$acti_class), fill = TRUE)
