...
loc <- subset(loc, select = c("id_site", 
  "site",
  "nom",
  "id_protocole",
  "latitude",
...
parti_ok_loc <- dplyr::inner_join(parti_ok, loc, by = c("idsite" = "id_site", "point" = "nom"))
...
write.csv2(unique_nights_ok_loc, file.path(data_vc, "parti_unique_non_confi.csv"))
