...
layer_alti <- file.path(loc, "data", "prep_data", "BDALTI")
Layer_Carthage_P <- file.path(loc, "data", "prep_data", "BD_TOPAGE_2023-shp", "SurfaceElementaire_FXX.shp")
Layer_Carthage_C <- file.path(loc, "data", "prep_data", "BD_TOPAGE_2023-shp", "TronconHydrographique_FXX.shp")
folder_CLC <- file.path(loc, "data", "prep_data", "CLC")
folder_OCS <- file.path(loc, "data", "prep_data", "OCS_OSO")
folder_route <- file.path(loc, "data", "prep_data","ROUTE500_3-0__SHP_LAMB93_FXX_2021-11-03")
